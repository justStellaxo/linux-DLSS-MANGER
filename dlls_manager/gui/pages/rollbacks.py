...
class RollbacksPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        layout.addWidget(QLabel("Rollback Manifests"))
        ...
        self.execute_btn = QPushButton("Restore Selected")
        ...
        self.empty_state_label.setStyleSheet("color: #8f98a0; padding: 20px;")
    ...
    def refresh(self) -> None:
        ...
        self.empty_state_label.setVisible(len(rollbacks) == 0)
    ...
    def _on_execute(self) -> None:
        ...
        self._worker.error.connect(lambda e: self.result_label.setText(f"Rollback error: {e}"))
        self._worker.start()